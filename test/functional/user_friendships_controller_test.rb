...
class UserFriendshipsControllerTest < ActionController::TestCase
	context "#new" do
		...
		context "when logged in" do
			...
			should "should set a flash error message if someone doesn't send in friend id " do
				get :new, {}
			...
			should "make sure user is the currently logged in user" do
				get :new, friend_id: users(:jim)
	...
	context "#create" do
		...
		context "when logged in" do
			...
			context "with no friend_id" do
				...
				should "get redirected to the root path" do
